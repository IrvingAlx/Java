...
public class PanelUnoEx extends JPanel {
	...
	public PanelUnoEx() {
		...
		JLabel etiquetaPss = new JLabel("Mide en 120 mg/dl", SwingConstants.LEFT);

		etiquetaPss.setBounds(480, 265, 400, 30);
		etiquetaPss.setFont(new Font("Abel_Regular", Font.ITALIC, 15));
		...
		JLabel etiquetahiper = new JLabel("Usted padece de:", SwingConstants.LEFT);

		etiquetahiper.setBounds(480, 330, 400, 30);
		etiquetahiper.setFont(new Font("Abel_Regular", Font.ITALIC, 15));
		...
		JLabel etiquetaFbs = new JLabel("Usted es fumador?", SwingConstants.LEFT);
		...
		JLabel etiquetadiab = new JLabel("Usted padece de:", SwingConstants.LEFT);

		etiquetadiab.setBounds(480, 460, 400, 30);
		etiquetadiab.setFont(new Font("Abel_Regular", Font.ITALIC, 15));

		this.add(etiquetadiab); //entre los 40 y los 60 mg/dL
		...
		JLabel etiquetahdl = new JLabel("*entre los 40 y los 60 mg/dL", SwingConstants.LEFT);

		etiquetahdl.setBounds(480, 525, 400, 30);
		etiquetahdl.setFont(new Font("Abel_Regular", Font.ITALIC, 15));
