...
public class ManipularBaseDatos {
	...
	public void Insertar(int edad,int presionSistolica,boolean Hipertension,int HDL,boolean Fumador,boolean Diabetes,int Colesterol,boolean sexo) {
		try {
			...
			JOptionPane.showMessageDialog(null,"Se agrego con �xito a la abse de datos"+JOptionPane.INFORMATION_MESSAGE); 
