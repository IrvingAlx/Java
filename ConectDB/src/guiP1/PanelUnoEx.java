...
public class PanelUnoEx extends JPanel {
	...
	JLabel imagen = new JLabel(new ImageIcon("G:\\Mi unidad\\Ibero\\4.- Cuarto Semestre\\Pogramacion Orientada a Objetos\\Proyecto 3\\bg2.png"));
	...
	buttonGroupHiper.add(radioButtonHiper1);buttonGroupHiper.add(radioButtonHiper2);    
	this.add(radioButtonHiper1);this.add(radioButtonHiper2);      
	this.setSize(300,300);    
	this.setLayout(null);    
	this.setVisible(true);   
	...
	buttonGroupFum.add(radioButtonFum1);buttonGroupFum.add(radioButtonFum2);    
	this.add(radioButtonFum1);this.add(radioButtonFum2);      
	this.setSize(300,300);    
	this.setLayout(null);    
	this.setVisible(true);   
	...
	buttonGroupDiab.add(radioButtonDiab1);buttonGroupDiab.add(radioButtonDiab2);    
	this.add(radioButtonDiab1);this.add(radioButtonDiab2);      
	this.setSize(300,300);    
	this.setLayout(null);    
	this.setVisible(true);   	
