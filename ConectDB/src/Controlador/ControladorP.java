...
public class ControladorP implements ActionListener {
	...
	// M�todo que iTplenenta ActionListener
	...
	if(e.getSource() == EjemploGUI.buttonUpload) {
		...
		if (hiperTxt.isEmpty()){
            JOptionPane.showMessageDialog(null,"Error, eija una opicion para hipertensi�n"+JOptionPane.ERROR_MESSAGE); 
            errorT++;
		}
		...
		if (diabTxt.isEmpty()){
            JOptionPane.showMessageDialog(null,"Error, eija una opicion para daibetes"+JOptionPane.ERROR_MESSAGE); 
            errorT++;
		}
		...
		try{
			...
			JOptionPane.showMessageDialog(null, "Error en valor Edad : " + PanelUnoEx.areaTextoEdad.getText().toString() + JOptionPane.ERROR_MESSAGE);
		}
		...
		try{
			...
			JOptionPane.showMessageDialog(null, "Error en valor Presion: " + PanelUnoEx.areaTextoPSS.getText().toString() + JOptionPane.ERROR_MESSAGE);
		}
		...
		try{
			...
			JOptionPane.showMessageDialog(null, "Error en valor HDL: " + PanelUnoEx.areaTextoHDL.getText().toString() + JOptionPane.ERROR_MESSAGE);
		}
		try{
			...
			JOptionPane.showMessageDialog(null, "Error en valor Colesterol: " + PanelUnoEx.areaTextoChol.getText().toString() + JOptionPane.ERROR_MESSAGE);
		}
